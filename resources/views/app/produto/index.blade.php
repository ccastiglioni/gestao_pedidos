...
@section('conteudo')
    ...
    <div class="conteudo-pagina">
        ...
        <div class="menu">
            <ul>
                <li><button><a href="{{ route('produto.create') }}">Novo</a></button></li>
                    ...
                    <tbody>
                        @foreach ($produtos as $produto)
                            <tr>
                                ...
                                <td>{{ $produto->fornecedor_pertenc_um_produto->nome }}</td>
                                <td>{{ $produto->peso }}</td>
                                <td>{{ $produto->unidade_id }}</td>
                                <td>{{ $produto->produtoDetalhe_hasOne->comprimento ?? '' }}</td>
                                <td>{{ $produto->produtoDetalhe_hasOne->altura ?? '' }}</td>
